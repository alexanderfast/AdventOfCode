...
namespace Day6_2
{
	static class Input
	{
		public static string Test1 = @"turn on 0,0 through 999,999";

		public static string Test2 = @"toggle 0,0 through 999,0";

		public static string Test3 = @"turn off 499,499 through 500,500";

		public static string Part2Test1 = "turn on 0,0 through 0,0";

		public static string Part2Test2 = "toggle 0,0 through 999,999";
